...
Source Server         : 120.24.237.13
Source Server Version : 50521
Source Host           : 120.24.237.13:3306
Source Database       : admin_v2

Target Server Type    : MYSQL
Target Server Version : 50521
File Encoding         : 65001

Date: 2018-08-11 23:46:02
*/
...
-- ----------------------------
INSERT INTO `system_config` VALUES ('148', 'site_name', '后台管理系统');
INSERT INTO `system_config` VALUES ('149', 'site_copy', '通用后台管理系统© 2018');
...
INSERT INTO `system_config` VALUES ('173', 'app_name', '后台管理系统');
...
CREATE TABLE `system_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=33 DEFAULT CHARSET=utf8 COMMENT='系统操作日志表';
...
) ENGINE=InnoDB AUTO_INCREMENT=88 DEFAULT CHARSET=utf8 COMMENT='系统菜单表';
...
INSERT INTO `system_menu` VALUES ('87', '0', '首页', '', '', 'admin/index/home', '', '_self', '0', '1', '0', '2018-08-11 11:16:25');
...
-- ----------------------------
INSERT INTO `system_user` VALUES ('10000', 'admin', '21232f297a57a5a743894a0e4a801fc3', '22222222', 'sdfsd@Qq.com1', '13888888855', 'dfgsdfgsfd', '27058', '2018-08-11 23:40:30', '1', '301,302,303,304', '0', null, '2015-11-13 15:14:22');
